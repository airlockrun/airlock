...
func (s *MCPServer) handleResourcesList(ctx context.Context, w http.ResponseWriter, h *agentHandler, q *dbq.Queries, target dbq.Agent, access agentsdk.Access, msg jsonrpcMessage) {
...
func (s *MCPServer) handleResourcesRead(ctx context.Context, w http.ResponseWriter, h *agentHandler, q *dbq.Queries, target dbq.Agent, access agentsdk.Access, msg jsonrpcMessage) {
	var params struct {
		URI string `json:"uri"`
	}
